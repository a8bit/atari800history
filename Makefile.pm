...
CFLAGS		= -c -g -mpentium -fomit-frame-pointer -ffast-math -O3 -DGNU_C -DAT_USE_ALLEGRO -DAT_USE_ALLEGRO_JOY -DUSE_DOSSOUND -DDELAYED_VGAINIT -DPOKEY_UPDATE -DSIGNED_SAMPLES -DCLIP
